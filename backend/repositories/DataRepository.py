...
class DataRepository:
    ...
    @staticmethod
    def read_settings():
        sql = "SELECT daily_goal, daily_range, opslag, appname, datum FROM tbl_settings WHERE IDsettings = (select idsettings from tbl_settings order by idsettings desc limit 1) ORDER BY datum ASC LIMIT 10"
